...
public interface StudyMaterialRepositary extends JpaRepository<StudyMaterial, Integer> {
	...
	List<StudyMaterial> findByDocumentTypeAndDescriptionContaining(int type, String description);
	
	List<StudyMaterial> findByDocumentTypeAndSubjectIdAndDescriptionContaining(int type, int subjectId, String description);

	StudyMaterial findByDocumentId(int documentId);
