			...
			<c:if test="${pageContext.request.userPrincipal.principal.user.userType == 'ADMIN2'}">
		 		<h1 class="h3 mb-0 text-gray-800">3333333</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                <a href="/admin-student-foundation">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                        ...
                        <h4 style="margin-top:20px;text-align:center">Evaluation Report </h4>               	                      	
                      	<canvas id="myChart" width="1200" height="600" class="chartjs-render-monitor" style="display: block; height: 400px; width: 800px;"></canvas>
