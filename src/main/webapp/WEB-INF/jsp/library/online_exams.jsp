...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">Online Exams</h1>
    ...
    <div class="row">   
      ...
      <div class="col-md-12">
        ...
        <!-- Search Widget -->
        <div class="card mb-4">
          <h5 class="card-header">Search Exams</h5>
          <div class="card-body">
            <div class="input-group">         	
            <select class="form-control" style="margin-right:20px" id="select_subject">
              	<option value="0">All</option>
              	<c:forEach items="${subjects}" var="subject">
              		<option value="${subject.subjectId}" ${subjectId == subject.subjectId ? 'selected' : ''}>${subject.subjectName}</option>
            	</c:forEach>
            </select>
    ...
    <c:forEach var="item" items="${items}"> 
        ...
        <div class="card h-100">
          <a href="/e-library-download-item/${item.documentId}"></a>
          <div class="card-body">
            <h4 class="card-title">
              <img src="/library_template/img/file48.png" alt=""><a href="/e-library-download-exam/${item.documentId}" style="font-size:14px">Click hear to download</a>
            </h4>
            <p class="card-text" style="font-size:12px"><i>Exam ID - ${item.documentId}</i></p>
  ...
  <script>
	...
	$(document).ready(function(){
		...
		$('#btn_search').click(function(){
			...
			window.open('/e-library-exams?search=' + search + '&subjectId=' + subject, '_self');
		});
	});
