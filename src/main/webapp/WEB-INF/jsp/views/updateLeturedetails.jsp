...
<div class="signup-form">
			<form:form action="lectureupdate" method="post" modelAttribute="lecture" id="userfrom">
			...
			<div class="form-group">	
			<form:button class="btn btn-success"   onClick="saveUser()">Update personal details</form:button>
				<form:button type="button" class="btn btn-primary" onClick="lodaQualification()"
				data-toggle="modal" data-target="#exampleModal">Update Qualifications</form:button>
				</div>
		...
		function sendtoApprovalLecture(){
			debugger
						...
						document.getElementById("user_id-qualification").value = user;
							$.ajax({
								type : "GET",
								url : "/UpdatesendtoApprovalLecture/userId"+user,
								success : function(data) {
									if(data==1){
										 alert("Send to Approval Sucessfully..!");
										 document.location.href="/lecture-dashboard";
										}
